 ...
 *
 */
abstract class NtTransSetSecurityDescAccess extends SmbComNtTransaction {
    ...
    NtTransSetSecurityDescAccess() {
    }

    NtTransSetSecurityDescAccess(int fid, int securityInformation, SecurityDescriptor securityDescriptor, SID sid, int mask) {
        this.fid = fid;
